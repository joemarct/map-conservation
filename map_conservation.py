...
def execute_mapping(aln_file=None, pdb_file=None, structure_name=None):
    ...
    # If no errors, build the conservation mapping script
    if not errors:
...
if __name__ == '__main__':
    ...
    #except IndexError:
        # No arguments given means the input files are present in the
        # current working directory and were given the expected names
        #execute_mapping()
    #    print 'Hey'
    #    pass
